...
clear;
echo "*=======================================================================*";
echo "*===================== PV Administration ===============================*";
echo "*=======================================================================*";
echo " Do you want create PV on new scanned devices or existing device";
echo " 1. Create PV on new scanned disk (only for Redhat 5)";
...
multipath_out()
{
 cat /dev/null > /tmp/multipath-001.txt; cat /dev/null > /tmp/multipath-002.txt; cat /dev/null > /tmp/multipath-003.txt;
